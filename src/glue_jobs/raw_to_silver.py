...
def main() -> None:
    ...
    # Creamos una lista de las funciones que queremos ejecutar
    tasks = [process_unad, process_spadies, process_gobierno, process_snies]

    threads = []

    # Lanzamos todas las tareas al tiempo
    for task in tasks:
    ...
    job.commit()
    logger.info("Ejecución finalizada satisfactoriamente en paralelo.")